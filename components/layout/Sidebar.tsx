...
const menuItems = [
  ...
  { id: 'knowledge', label: '知识库', fullLabel: '经验知识库', icon: 'fa-book-open', path: '/knowledge' },
];
    ...
    <>
      ...
      <div className="hidden lg:flex w-64 bg-slate-900 text-white h-screen flex-col fixed left-0 top-0 z-50 shadow-xl transition-all">
        <div className="p-6 flex items-center border-b border-slate-800">
          ...
          <div>
            <h1 className="text-lg font-bold tracking-tight">商户运营</h1>
            <p className="text-xs text-slate-400">MallGuard AI</p>
          </div>
        </div>
